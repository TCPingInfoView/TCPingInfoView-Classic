...
namespace TCPingInfoViewTests.Util
{
	[TestClass]
	public class UtilTests
	{
		...
		public void StringLine2DataTest()
		{
			...
			var r1 = TCPingInfoView.Util.Util.StringLine2Data(s1);
			var r2 = TCPingInfoView.Util.Util.StringLine2Data(s2);
			var r3 = TCPingInfoView.Util.Util.StringLine2Data(s3);
			var r4 = TCPingInfoView.Util.Util.StringLine2Data(s4);
			var r5 = TCPingInfoView.Util.Util.StringLine2Data(s5);
			var r6 = TCPingInfoView.Util.Util.StringLine2Data(s6);
			var r7 = TCPingInfoView.Util.Util.StringLine2Data(s7);
