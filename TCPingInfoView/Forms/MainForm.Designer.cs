...
namespace TCPingInfoView.Forms
{
	partial class MainForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.MainList = new TCPingInfoView.Control.DoubleBufferedDataGridView();
			...
			this.DateList = new TCPingInfoView.Control.DoubleBufferedDataGridView();
			...
			// Search_TextBox
			// 
			this.Search_TextBox.CueBanner = "搜索";
			this.Search_TextBox.Name = "Search_TextBox";
			this.Search_TextBox.Size = new System.Drawing.Size(100, 25);
		...
		private DoubleBufferedDataGridView MainList;
		...
		private DoubleBufferedDataGridView DateList;
